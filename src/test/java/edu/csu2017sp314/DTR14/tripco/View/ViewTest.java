...
public class ViewTest {
	...
	public void testConstructor() {
		...
		View v1 = new View("hello", "test.svg", 300, new boolean[] {false, false, false}, true, 1);
		assertTrue("rootName not read correctly", v1.getRootName().equals("hello"));

		View v2 = new View("hello.csv", "test.svg", 300, new boolean[] {true, true, true}, false, 1);
	...
	public void testGetRootName() {
		View v3 = new View("helloWorld.csv", "test.svg", 300, new boolean[] {false, false, false}, true, 1);
	...
	public void testAddLeg() {
		view = new View("helloWorld.csv", "test.svg", 300, new boolean[] {false, true, false}, true,1);
		test = view.addLeg(new double[]{40, -108, 39, -107}, "Not Denver", "id1", "Not CO Springs", "id2", 50);
		assertTrue(test.equals("m"));
		view = new View("helloWorld.csv", "test.svg", 300, new boolean[] {true, true, true}, true,1);
	...
	public void testWriteFiles(){
		View v4 = new View("helloWorld.csv", "test.svg", 300, new boolean[] {false, false, false}, true, 1);
		v4.writeFiles();
