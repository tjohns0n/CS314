...
public class Query {
	...
	public Message getMessage(){
		for(int i = 0; i < mess.content.length; i++)
			System.out.println("mess = " + mess.content[i]);
		return mess;
	}
